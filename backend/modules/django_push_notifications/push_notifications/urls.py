...
from .viewsets import NotificationViewSet, NotificationDetailsBySubscriptionViewSet
...
urlpatterns = [
    ...
    path('user-notifications/<target_id>/', NotificationDetailsBySubscriptionViewSet.as_view({'get': 'retrieve'}), name='notification-details-user'),
    ...
    # path('user-notifications/', ListUserNotification.as_view(), name='notification-user'),
]